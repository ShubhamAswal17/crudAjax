        ...
        <div class="container-md p-4 m-4">
            <div class="addform">
                <form action="update.php" method="POST">
                    <div class="row g-3">
                        <div class="col m-4">
                             <input type="hidden" name="userid" value="<?php echo $userdata['id']; ?>" class="form-control">
                            <input type="text" name="name" value="<?php echo $userdata['name']; ?>" class="form-control" placeholder="Enter Name"
                                aria-label="First name">
                        </div>
                        <div class="col m-4">
                             <input type="email" name="email" value="<?php echo $userdata['email']; ?>" class="form-control" placeholder="Enter  Email"
                            aria-label="First name">
                        </div>
                    ...
                    <div class="row g-3">
                        <div class="col m-4">
                            <input type="text" name="address" value="<?php echo $userdata['address']; ?>"  class="form-control" placeholder="Enter Address"
                                aria-label="address">
                        </div>
                        <div class="col m-4">
